...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupFeedItem.erased'
        db.add_column(u'social_network_groupfeeditem', 'erased',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupFeedItem.erased'
        db.delete_column(u'social_network_groupfeeditem', 'erased')
