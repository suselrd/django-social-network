...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SocialGroup', fields ['slug', 'site']
        db.create_unique(u'social_network_socialgroup', ['slug', 'site_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'SocialGroup', fields ['slug', 'site']
        db.delete_unique(u'social_network_socialgroup', ['slug', 'site_id'])
