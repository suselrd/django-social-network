...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal(u'social_network', ['GroupComment'])
        ...
        db.send_create_signal(u'social_network', ['GroupSharedLink'])
        ...
        db.send_create_signal(u'social_network', ['GroupImage'])
